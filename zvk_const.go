...
IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_QCOM ImageCreateFlags = 0x00008000
...
func (v ImageCreateFlags) String() string {
	...
	if v.HasBits(IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_QCOM) {
		str += "FRAGMENT_DENSITY_MAP_OFFSET_QCOM|"
	}
