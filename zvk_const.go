...
FORMAT_FEATURE_TENSOR_SHADER_ARM FormatFeatureFlags = 0x8000000000
FORMAT_FEATURE_TENSOR_IMAGE_ALIASING_ARM FormatFeatureFlags = 0x80000000000
...
FORMAT_FEATURE_TENSOR_DATA_GRAPH_ARM FormatFeatureFlags = 0x1000000000000
FORMAT_FEATURE_COPY_IMAGE_INDIRECT_DST_KHR FormatFeatureFlags = 0x800000000000000
...
func (v FormatFeatureFlags) String() string {
	...
	if v.HasBits(FORMAT_FEATURE_TENSOR_SHADER_ARM) {
		str += "TENSOR_SHADER_ARM|"
	}
	if v.HasBits(FORMAT_FEATURE_TENSOR_IMAGE_ALIASING_ARM) {
		str += "TENSOR_IMAGE_ALIASING_ARM|"
	}
	...
	if v.HasBits(FORMAT_FEATURE_TENSOR_DATA_GRAPH_ARM) {
		str += "TENSOR_DATA_GRAPH_ARM|"
	}
	if v.HasBits(FORMAT_FEATURE_COPY_IMAGE_INDIRECT_DST_KHR) {
		str += "COPY_IMAGE_INDIRECT_DST_KHR|"
	}
