...
func main() {
	...
	out, err := os.Create(filepath.Join(dir, "vkfns.inc"))
	if err != nil {
		panic(err)
	}
	...
	if _, err := w.WriteString("// go run vkfns_gen.go\n// Code generated by the command above; DO NOT EDIT.\n\n"); err != nil {
		panic(err)
	}
